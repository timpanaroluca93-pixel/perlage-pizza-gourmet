    ...
    <main className="min-h-screen bg-[#070707] text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 md:px-6">
          <a href="#home" onClick={() => setMenuOpen(false)} className="shrink-0">
            <img src="/logo.png" alt="Perlage Pizza & Restaurant" className="h-14 w-auto object-contain md:h-28" />
          </a>
      ...
      <section id="home" className="relative min-h-[86vh] overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero4.jpg" alt="Perlage Pizza & Restaurant a Catania" className="h-full w-full object-cover" />
        ...
        <div className="relative mx-auto flex min-h-[86vh] max-w-7xl items-center px-6 py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-white/72">
              A Catania, in Via Asiago, Perlage unisce impasti ricercati, ingredienti selezionati,
              cucina italiana e un’atmosfera elegante pensata per cene, eventi e momenti speciali.
            </p>
      ...
      <section className="px-6 py-24">
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-[0.8fr_1.2fr] md:items-end">
          ...
          <p className="max-w-3xl text-lg leading-9 text-white/65">
            Perlage Pizza & Restaurant nasce per trasformare la cena in un percorso di gusto:
            pizze contemporanee, cucina italiana, vini selezionati e dettagli pensati per offrire
            un’esperienza raffinata ma accogliente.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-xl text-base leading-8 text-white/60">
              ...
              eleganza, convivialità e gusto contemporaneo.
            </p>
          </div>
      ...
      <section id="menu" className="px-6 py-28">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/65">
            Dalle pizze gourmet agli antipasti territoriali, dai fritti alle proposte di cucina:
            il menu Perlage è pensato come un viaggio tra Nord, Centro e Sud Italia.
          </p>
          ...
          <div className="grid gap-12 md:grid-cols-[0.9fr_1.1fr]">
            ...
            <div>
              <p className="text-lg leading-9 text-white/65">
                Organizziamo compleanni, lauree, cene aziendali, anniversari ed eventi privati
                in un ambiente curato, con menu dedicati e soluzioni personalizzate per ogni occasione.
              </p>
      ...
      <footer className="border-t border-white/10 px-6 py-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <img src="/logo.png" alt="Perlage Pizza & Restaurant footer logo" className="h-14 w-auto object-contain" />
